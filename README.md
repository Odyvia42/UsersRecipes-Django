...
6. Отображение топ-5 рецептов по рейтингу на главной странице сайта.
7. Документация сайта.
8. Отображение всех рецептов конкретного пользователя, с сортировкой по категориям.
9. Сортировка избранного для конкретного пользователя по категориям блюда.
